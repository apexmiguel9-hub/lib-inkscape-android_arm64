...
template <>
class PANGOMM_API Value<Pango::FontColor> : public Glib::Value_Enum<Pango::FontColor>
{
public:
  static GType value_type() G_GNUC_CONST;
};
...
/** 
 *  @var Width::ULTRA_CONDENSED
 * Ultra condensed width.
 * 
 *  @var Width::EXTRA_CONDENSED
 * Extra condensed width.
 * 
 *  @var Width::CONDENSED
 * Condensed width.
 * 
 *  @var Width::SEMI_CONDENSED
 * Semi condensed width.
 * 
 *  @var Width::NORMAL
 * The normal width.
 * 
 *  @var Width::SEMI_EXPANDED
 * Semi expanded width.
 * 
 *  @var Width::EXPANDED
 * Expanded width.
 * 
 *  @var Width::EXTRA_EXPANDED
 * Extra expanded width.
 * 
 *  @var Width::ULTRA_EXPANDED
 * Ultra expanded width.
 */
 /** An enumeration specifying the width of the font relative to other designs
 * within a family.
 * 
 * The enumeration values match Pango::PangoStretch, but
...
template <>
class PANGOMM_API Value<Pango::Width> : public Glib::Value_Enum<Pango::Width>
{
public:
  static GType value_type() G_GNUC_CONST;
};
...
public:
   ...
   * @newin{2,58}
   * 
   * @return The width field for the font description.
   * Use get_set_fields() to find
   * out if the field was explicitly set or not.
   */
   ...
   * @newin{1,57}
   * 
   * @param color The `Pango::FontColor` value.
   */
  void set_color(FontColor color);
