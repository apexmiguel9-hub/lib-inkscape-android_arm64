...
/** 
 *  @var RenderComponent::NONE
 * No components.
 * 
 *  @var RenderComponent::PLAIN_GLYPH
 * The plain glyphs of the layout.
 * 
 *  @var RenderComponent::COLOR_GLYPH
 * The color glyphs of the layout.
 * 
 *  @var RenderComponent::BACKGROUND
 * Background of the layout.
 * 
 *  @var RenderComponent::UNDERLINE
 * Underlines of the layout.
 * 
 *  @var RenderComponent::STRIKETHROUGH
 * Strikethrough lines of the layout.
 * 
 *  @var RenderComponent::OVERLINE
 * Overlines of the layout.
 */
 /** Flags that specify which components of a layout to include
 * in renderer output.
 * 
 * This is more or less parallel to the Pango::RenderPart enum,
 ...
 * <tt>RenderComponent operator|(RenderComponent, RenderComponent)</tt><br>
 * <tt>RenderComponent operator&(RenderComponent, RenderComponent)</tt><br>
 * <tt>RenderComponent operator^(RenderComponent, RenderComponent)</tt><br>
 * <tt>RenderComponent operator~(RenderComponent)</tt><br>
 * <tt>RenderComponent& operator|=(RenderComponent&, RenderComponent)</tt><br>
 * <tt>RenderComponent& operator&=(RenderComponent&, RenderComponent)</tt><br>
 * <tt>RenderComponent& operator^=(RenderComponent&, RenderComponent)</tt><br>
 */
...
/** @ingroup pangommEnums */
inline RenderComponent operator|(RenderComponent lhs, RenderComponent rhs)
  { return static_cast<RenderComponent>(static_cast<unsigned>(lhs) | static_cast<unsigned>(rhs)); }
...
/** @ingroup pangommEnums */
inline RenderComponent operator~(RenderComponent flags)
  { return static_cast<RenderComponent>(~static_cast<unsigned>(flags)); }

/** @ingroup pangommEnums */
inline RenderComponent& operator|=(RenderComponent& lhs, RenderComponent rhs)
  { return (lhs = static_cast<RenderComponent>(static_cast<unsigned>(lhs) | static_cast<unsigned>(rhs))); }
...
template <>
class PANGOMM_API Value<Pango::RenderComponent> : public Glib::Value_Flags<Pango::RenderComponent>
{
public:
  static GType value_type() G_GNUC_CONST;
};
...
public:
  ...
  */
   ...
   */
  void add_components_to_cairo_context(const Cairo::RefPtr<Cairo::Context>& context,
