...
protected:
  ...
  static void draw_trapezoid_vfunc_callback(PangoRenderer* self, PangoRenderPart part, double y1_, double x11, double x21, double y2, double x12, double x22);
  ...
  static void prepare_run_vfunc_callback(PangoRenderer* self, PangoLayoutRun* run);
