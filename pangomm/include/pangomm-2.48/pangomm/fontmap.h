...
public:
  ...
  /** Returns a new font that is like @a font, except that it is scaled
   * by @a scale, its backend-dependent configuration (e.g.\ cairo font options)
   * is replaced by the one in @a context, and its variations are replaced
   * by @a variations.
   * 
